...
class JayhawksWorker(Worker):
    def __init__(self, config={}):
        ...
        self.tool_source = 'Jayhawks Location Worker'
        self.tool_version = '0.0.1'
        self.data_source = 'Commit records from the facade worker, stored in the commits table.'

    def location_model(self, task, repo_id):
        ...
        #   for another task
        self.register_task_completion(task, repo_id, 'location')
